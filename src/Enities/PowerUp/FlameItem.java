...
public class FlameItem extends Enity {
    ImageView imageView;
    Convention convention = new Convention();
    public FlameItem(double x, double y, double width, double heigth, String imgpath) {
        super(x, y, width, heigth, imgpath);
    }

    public void renderFlameItem(Group root) {
        Image image = null;
        try {
