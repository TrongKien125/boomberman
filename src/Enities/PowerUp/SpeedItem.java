...
public class SpeedItem extends Enity {
    ImageView imageView;
    Convention convention = new Convention();
    public SpeedItem(double x, double y, double width, double heigth, String imgpath) {
        super(x, y, width, heigth, imgpath);
    }

    public void renderSpeedItem(Group root) {
        Image image = null;
        try {
